import type { ConfigurationEntity, EntityType } from 'audako-core-components';
import {
  delay,
...
function dispatchEntityEvent(
  entityType: EntityType,
  oldEntity: ConfigurationEntity,
  newEntity: ConfigurationEntity,
): void {
  document.dispatchEvent(
    new CustomEvent<any>('entity-changed', {
      detail: { oldEntity: oldEntity, newEntity: newEntity, entityType: entityType },
    }),
  );
}
